    ...
    formulario.addEventListener(
        ...
        async function (evento) {
            ...
            try {
                ...
                // Verifica se a API rejeitou a requisição e apresenta a mensagem retornada pelo backend.
                if (!resposta.ok) {
                ...
                /*
                    Esse bloco é executado quando ocorre uma falha
                    de rede ou quando a API está indisponível.
                */
                console.error(
